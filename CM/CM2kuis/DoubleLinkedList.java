package CM.CM2kuis;
import CM.CM2kuis.NodeCM.NodePembeli;
import CM.CM2kuis.NodeCM.NodePesanan;
...
public class DoubleLinkedList {
    ...
    //Fungsi tambah antreanPrioritas Baru
    public void tambahAntreanPrioritas(Pembeli dataBaru){
        NodePembeli newNode = new NodePembeli(null, dataBaru, null);

        if (isEmptyPembeli()) {
            head1 = tail1 = newNode;
        }else{
            if (dataBaru.namaPembeli.compareToIgnoreCase(head1.data1.namaPembeli) < 0) {
                newNode.next1 = head1;
                head1.prev1 = newNode;
                head1 = newNode;
            }else{
