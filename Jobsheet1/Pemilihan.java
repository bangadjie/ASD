...
public class Pemilihan {
    public static void main(String[]args){
        ...
        if ((0 < nilaiTgs1 && nilaiTgs1 > 100) || (0 < nilaiKuis && nilaiKuis > 100) || (0 < nilaiUts1 && nilaiUts1 > 100) || (0 < nilaiUas1 && nilaiUas1 > 100)) {
        System.out.println("===============================================");
        System.out.println("===============================================");
        ...
        System.out.println("===============================================");
            ...
            double nilaiAkhir1 = (nilaiTgs1 * 0.2) + (nilaiKuis * 0.2) + (nilaiUts1 * 0.3) + (nilaiUas1 * 0.4);
